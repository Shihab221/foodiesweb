  ...
  return (
    <div className="w-full ">
      <div className=" flex flex-row justify-between">
        <div className="bg-white text-slate-800 flex sm:flex-row flex-col rounded-lg w-full">
          <img
            src={food.image}
            alt="food_image"
            width={100}
          ...
          <div className="px-4 py-6 flex flex-col justify-between">
            ...
            <p className="text-slate-800 mt-2 max-w-xl">Delivery Time: {food.delivery_time}</p>
